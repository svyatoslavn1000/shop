package com.geekbrains.market.paypal;

import com.geekbrains.market.services.MailService;
import com.geekbrains.market.services.OrderService;
...
public class PayPalController {
    ...
    public String buy(Model model, @PathVariable(name = "orderId") Long orderId, Principal principal) {
        try {
            com.geekbrains.market.entities.Order order = orderService.findById(orderId);
