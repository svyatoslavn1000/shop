package com.geekbrains.market.aop;
...
//    }
    ...
    @Before("execution(public String com.geekbrains.market.controllers.MarketController.index(..))")
    public void beforeUserModifyInUserDAOClass() {
        System.out.println("AOP: работа с главной страницей");
    }
...
//    }
    ...
    @Before("execution(public String com.geekbrains.market.controllers.MarketController.*(..))")
    public void beforeAnyMethodInMarketControllerClassWithDetails(JoinPoint joinPoint) {
        MethodSignature methodSignature = (MethodSignature) joinPoint.getSignature();
        log.info("В MarketController был вызван метод: " + methodSignature);
...
//    @Around("execution(public * com.geekbrains.market.controllers.*(..))")
